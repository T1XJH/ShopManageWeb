...
public class OrderInformation {
    ...
    public OrderInformation(String addressu, String unameu, String uphoneu, String oid, int ouid, Date otime, Date osuretime, BigDecimal omoney, String ostatus, int address, int sid, String spid, int suid, String sstatus, int shoppingcount, String pid, String pname, int ptid, String pimg, BigDecimal pprice, String pstatus, int pnumber, String detailed) {
        this.addressu = addressu;
        this.unameu = unameu;
        this.uphoneu = uphoneu;
        this.oid = oid;
    ...
    public OrderInformation(String oid, int ouid, Date otime, Date osuretime, BigDecimal omoney, String ostatus, int address, int sid, String spid, int suid, String sstatus,  int shoppingcount, String pid, String pname, int ptid, String pimg, BigDecimal pprice, String pstatus, int pnumber, String detailed) {
        this.oid = oid;
        this.ouid = ouid;
        this.otime = otime;
        this.osuretime = osuretime;
    ...
    public OrderInformation(int ouid,BigDecimal omoney, int address) {
        this.ouid = ouid;
        this.omoney = omoney;
        this.address = address;
    }

    public OrderInformation(String oid, int ouid, Date otime, Date osuretime, BigDecimal omoney, String ostatus, int address) {
        this.oid = oid;
        this.ouid = ouid;
        this.otime = otime;
        this.osuretime = osuretime;
